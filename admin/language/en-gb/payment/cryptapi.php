...
$_['text_cryptapi'] = '<a target="_BLANK" href="https://cryptapi.io/"><img src="' . $base_url . '/extension/cryptapi/admin/view/image/payment/blockbee.png" alt="cryptapi" title="cryptapi" style="border: 1px solid #EEEEEE; height:37px" /></a>';
$_['text_connect_cryptapi'] = 'This module allows you to accept CryptAPI Payments securely.';
$_['text_cryptapi_image'] = '<a target="_BLANK" href="https://cryptapi.io/"><img src="' . $base_url . '/extension/cryptapi/admin/view/image/payment/blockbee.png" alt="cryptapi" title="cryptapi" style="height:50px" class="img-fluid" /></a>';
